              ...
              {typeDropdownOpen && (
                <div className="absolute top-full left-0 mt-1 w-40 bg-white border border-[#e5e7eb] rounded-lg shadow-lg z-10">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 text-left text-sm text-[#374151] hover:bg-[#f9fafb] rounded-b-lg"
                  >
                    CPQ-based
                  </button>
                </div>
              ...
              <tr key={template.id} className="hover:bg-[#f9fafb] transition-colors">
                ...
                <td className="px-4 py-4">
                  <div className="flex items-center gap-2 min-w-0">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold shrink-0 ${template.createdBy.bgColor} ${template.createdBy.textColor}`}
                    >
